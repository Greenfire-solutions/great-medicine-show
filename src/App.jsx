              ...
              <>
                ...
                {selectedCourse ? (
                  <article className="overlay-card">
                    ...
                    <p className="small">{selectedCourse.price} · {selectedCourse.duration} · {selectedCourse.format}</p>
                    ...
                    <div className="dialogue-actions">
                      ...
                      <button className="arcade-button" onClick={() => openBookingForm(selectedCourse.contactSubject)}>
                      ...
                      {filteredCourses.length === 0 ? (
                        ...
                        filteredCourses.map((course) => (
                          <article key={course.id} className="overlay-card">
                            ...
                            <p className="small">{course.price} · {course.duration} · {course.format}</p>
                            <p className="small">{course.description}</p>
                            <button className="arcade-button" onClick={() => setSelectedCourse(course)}>
                              View Course Details
                            </button>
                          </article>
                        ))
