...
function App() {
  ...
  const togglePreview = () => {
    ...
    if (audioRef.current.paused) {
      audioRef.current.play().then(() => setIsTrackPlaying(true)).catch(() => setPlayerMessage('Track unavailable'))
    } else {
      audioRef.current.pause()
      setIsTrackPlaying(false)
    }
                  ...
                  <div>
                    ...
                    <audio
                      ...
                      onError={() => {
                        ...
                        setPlayerMessage('Track unavailable')
                      }}
                      ...
                      <div className="track-selector">
                        {filteredTracks.length === 0 ? (
                          ...
                          filteredTracks.map((track) => {
                            const actualIndex = musicData.findIndex((item) => item.id === track.id)
                            return (
                              <button
                                key={track.id}
