...
const mapDefinitions = {
  ...
  hall: {
    ...
    nodes: [
      { id: 'music', name: 'Music Hall Shop / Room', x: 20, y: 26, tone: 'music', type: 'page' },
      { id: 'store', name: 'Store Shop / Room', x: 80, y: 28, tone: 'store', type: 'page' },
      { id: 'shows', name: 'Shows Amphitheater / Booking Desk', x: 50, y: 52, tone: 'shows', type: 'page' },
      { id: 'course-link', name: 'Course Academy Portal', x: 18, y: 76, tone: 'courses', type: 'page' },
      { id: 'hall-exit', name: 'Back to Overworld Exit', x: 80, y: 78, tone: 'exit', type: 'map', targetMap: 'overworld' }
    ]
  },
  civilx: {
            ...
            <div className="rpg-map" role="group" aria-label="2D RPG world map">
              ...
              {dialogueNode && (
                <div className="dialogue-bubble" role="dialog" aria-label="Interaction dialogue">
                  <p>Interact with {dialogueNode.name}?</p>
