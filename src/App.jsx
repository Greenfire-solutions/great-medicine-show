...
function App() {
  ...
  return (
    <div className={`app-shell arcade-screen ${step < 4 ? 'onboarding-mode' : ''}`}>
      ...
      {step === 1 && (
        <section className="intro-panel intro-onboarding-screen">
      ...
      {step === 2 && (
        <section className="onboarding-step guild-onboarding-screen">
          <h2 className="glyph-title">Choose Your Elemental Guild</h2>
          <div className="glowing-divider" />
          <div className="guild-choice-grid">
            {guilds.map((option) => {
              const elementTone = option.split(' ')[0].toLowerCase()
              return (
              <article key={option} className={`guild-choice tone-${elementTone} ${guild === option ? 'selected' : ''}`}>
                <button
                ...
                <button className="guild-image-button" onClick={() => setGuild(option)}>
                  <img
                    src="https://pub-4cf809a1f40f409f93cbf7ded1f9e822.r2.dev/great-medicine-media/ui/buttons/button-2.png"
                    alt=""
                    aria-hidden="true"
      ...
      {step === 3 && (
        <section className="onboarding-step name-onboarding-screen">
          <h2 className="glyph-title name-screen-title">Name Your Character</h2>
          <img
            className="name-title-panel"
            src="https://pub-4cf809a1f40f409f93cbf7ded1f9e822.r2.dev/great-medicine-media/ui/panels/Title%20-panel-1.png"
            alt="Name your character"
          />
          <div className="name-input-panel">
            <img
              className="name-input-panel-bg"
              src="https://pub-4cf809a1f40f409f93cbf7ded1f9e822.r2.dev/great-medicine-media/ui/panels/Title%20-panel-2.png"
              alt=""
              aria-hidden="true"
            />
