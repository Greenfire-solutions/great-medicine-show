      ...
      {step === 4 && (
        <section className="arcade-panel world-panel">
          ...
          <div className="world-content">
            ...
            {hallOverlay && (
              <section className="arcade-panel hall-overlay" aria-label="Hall location content panel">
                {hallOverlay === 'music' && (
                  <>
                    ...
                    <div className="music-shell">
                      ...
                      <div>
                        <p className="small">Track Title Placeholder</p>
                        <div className="music-controls">
                          <button className="arcade-button">Previous</button>
                          <button className="arcade-button">Play / Pause</button>
                          <button className="arcade-button">Next</button>
                        </div>
                        <div className="track-list">Track list placeholder area</div>
                        <div className="platform-links">
                          {['Spotify', 'SoundCloud', 'Bandcamp', 'YouTube'].map((platform) => (
                            <button key={platform} className="arcade-button">
                              {platform}
                            </button>
                          ))}
                        </div>
                ...
                {hallOverlay === 'store' && (
                  <>
                    ...
                    <div className="overlay-grid">
                      {['Merch', 'Music Downloads', 'Beats / Licenses', 'Event Tickets', 'Courses'].map((item) => (
                        <article key={item} className="overlay-card">
                          <h4>{item}</h4>
                ...
                {hallOverlay === 'shows' && (
                  <>
                    ...
                    <div className="overlay-grid">
                      {[
                        'Upcoming Shows',
                        'Book The Great Medicine Show',
                        'Private Events / Retreats / Festivals'
                      ].map((item) => (
                        <article key={item} className="overlay-card">
                          <h4>{item}</h4>
                          <p className="small">Placeholder details coming soon.</p>
                        </article>
                      ))}
                    </div>
                    <button className="arcade-button">Contact / Booking Inquiry</button>
                  </>
                )}
                  ...
                  <>
                    ...
                    <div className="overlay-grid">
                      {[
                        ...
                        <article key={course} className="overlay-card">
                          <h4>{course}</h4>
                          <button className="arcade-button">View Item</button>
                        </article>
                      ))}
                    </div>
                  </>
